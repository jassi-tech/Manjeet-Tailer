        ...
        <section id="gallery" className="py-s-120 bg-white text-center">
            <FluidContainer>
                <div className="text-center mb-s-80">
                    <h2 className="text-s-48 font-bold text-[#065f46] mb-s-24">{gallery.title}</h2>
                ...
                {/* CTA SECTION */}
                <div className="bg-[#00a854] rounded-s-24 p-s-20 text-center text-white shadow-2xl">
                    ...
                    <button
                        onClick={onBookClick}
                        className="bg-white text-[#00a854] px-s-48 py-s-20 rounded-s-12 font-bold text-s-18 hover:bg-slate-50 transition-colors"
                    >
